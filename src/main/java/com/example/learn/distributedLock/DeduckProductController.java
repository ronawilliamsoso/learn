package com.example.learn.distributedLock;
...
/**
 * @program: demo
 * @description: 测试分布式锁 redession， 这个似乎是最可靠的 redis 分布式锁
 *                ﻿setnx()  expire()  两个操作也能做分布式锁，但是两步操作不是原子的，无法 100%可靠
 * @author: Wei.Wang
 * @create: 2019-11-21 22:37
 **/

@RestController
public class DeduckProductController{
